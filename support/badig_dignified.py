...
class Description:
    ...
    def __init__(self):
        ...
        # General identifiers snake separator
        self.d_idsnake = '_'
        ...
        # Remtags commands
        self.d_remtcm = ['EXPORT_FILE', 'CONVERT_ONLY', 'TOKENIZE', 'ARGUMENTS']
        ...
        # Shared with some classic Basics call instruction
        #    Decided in parser based on position relative to end of line
        d_instsp = r'^_$'
        self.d_instsp_str = '_'
        ...
        r'(?P<d_funcal>)'
        # Proxy token for use according to special cases
        # (use token value to differentiate multiple uses)
        r'(?P<d_spcial>)'

        # Identifier with type and named group for compilation
